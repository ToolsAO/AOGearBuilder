<script lang="ts">
	...
	let embed = "?code="+$page.url.hash.replace("#", "");
...
<svelte:head>
	...
	<meta property="og:image" content="https://toolsao.vercel.app/embed.gif{"?code="+window.location.hash.substring(1)}" />
	...
	<meta property="twitter:image" content="https://toolsao.vercel.app/embed.gif{"?code="+window.location.hash.substring(1)}" />
